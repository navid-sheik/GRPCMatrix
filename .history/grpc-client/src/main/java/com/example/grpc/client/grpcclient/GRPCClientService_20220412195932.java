...
public class GRPCClientService {
	...
	private static  void clientOperation(int[][] matrixA, int[][] matrixB){
		...
		List<MatrixServiceGrpc.MatrixServiceBlockingStub> listOfStubs  =  new ArrayList<MatrixServiceGrpc.MatrixServiceBlockingStub>(stub1,stub2, stub3,stub4,stub5,stub6,stub7,stub8);
